...
- Criação da variável total_sales
- Avaliação da qualidade e consistência do dataset

### 2. Análise Exploratória (EDA)
- Lançamentos por ano
- Evolução de vendas por plataforma
- Correlação entre avaliações e vendas
- Análise dos gêneros mais rentáveis
- Visualizações diversas

### 3. Perfil Regional (NA, EU, JP)
- Plataformas mais populares
- Gêneros dominantes
- Impacto das classificações ESRB nas vendas
- Diferenças culturais no consumo de jogos

### 4. Testes de Hipóteses
Hipóteses avaliadas:
- Igualdade das avaliações médias de Xbox One vs PC
- Diferença entre avaliações de Action vs Sports
...
**Bruno Trindade**  
Analista de Dados  
GitHub: https://github.com/brunoatrindade  
LinkedIn: https://linkedin.com/in/brunoatrindade  
